...
const Header: React.FC<HeaderProps> = ({ children, className }) => {
    ...
    return (
        <div className={twMerge(`h-fit bg-gradient-to-b from-emerald-800 p-4`, className)}>
            <div className="w-full mb-4 flex items-center justify-between">
                ...
                <div className="flex md:hidden gap-x-2 items-center">
                    <button onClick={() => router.push('/')} className="rounded-full p-2 bg-white flex items-center justify-center hover:opacity-75 translate">
                        <HiHome className="text-black" size={20} />
                    </button>
                    <button onClick={() => router.push('/search')} className="rounded-full p-2 bg-white flex items-center justify-center hover:opacity-75 translate">
